...
class ExploreRepositoryImpl extends PartySportApiService implements ExploreRepository {
  ...
  @override
  Future<CuratedPartyListResponse?> getEvents({required String eventType,required int? page,required int? limit,String? location,num? minPrice,num? maxPrice,String? themeId,num? month}) async{
    final response = await getRequest(ApiUrl.eventsGet + '/' + eventType,queryParams: {
      ...
      if(themeId?.isNotEmpty ?? false) "themeName": themeId,
